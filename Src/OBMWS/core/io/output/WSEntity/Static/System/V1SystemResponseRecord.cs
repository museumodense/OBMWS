...
namespace OBMWS
{
    public class V1SystemResponseRecord : WSStaticRecord
    {
        ...
        internal static bool IsValid(V1SystemResponseRecord response) { 
            return response != null && response.entity != null && !string.IsNullOrEmpty(((V1SystemResponseEntity)response.entity).status);
        }
    }
}
